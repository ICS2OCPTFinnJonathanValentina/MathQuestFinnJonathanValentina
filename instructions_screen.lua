...
local music = audio.loadSound("Sounds/instructionsMusic.mp3")
local musicChannel 
...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/InstructionsScreenJonathan.png", display.contentWidth, display.contentHeight)
...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        music = audio.play(music, { channel=1, loops=-1 } )
